...
const mostBlogs = (blogs) => {
  ...
  return mostBlogsAuthor ? { author: mostBlogsAuthor, blogs: authorCount[mostBlogsAuthor] } : null
}
const mostlikes = (blogs) => {
  ...
  return mostLikedAuthor ? { author: mostLikedAuthor, likes: authorLikes[mostLikedAuthor] } : null
}
